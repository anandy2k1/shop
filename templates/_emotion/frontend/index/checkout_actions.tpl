...
<div class="my_options">
        ...
        <a href="{url controller='account'}" title="{s namespace='frontend/index/checkout_actions' name='IndexLinkAccount'}{/s}" class="account-2">
           <!-- {s namespace='frontend/index/checkout_actions' name='IndexLinkAccount'}{/s} -->
        </a>
        {/block}

        {block name="frontend_index_checkout_actions_notepad"}
		<a href="{url controller='note'}" title="{s namespace='frontend/index/checkout_actions' name='IndexLinkNotepad'}{/s}" {if $sNotesQuantity > 0}style="padding-right: 25px;"{/if} class="note-2">
        ...
        <span class="service">
            <span class="help-service">Service/Hilfe<!--{s name='IndexLinkService'}{/s}--></span>
