...
?>
<script type="text/javascript" src="<?php echo JURI::base() ?>js/jquery.js"></script>
<script type="text/javascript" src="<?php echo JURI::base() ?>js/validation.js"></script>
<script type="text/javascript" src="<?php echo JURI::base() ?>js/browser.js"></script>
...
function add_countries() {
    new Request.JSON({
        ...
        'onSuccess': function (json, text) {
            ...
            try {
                var shipstate = getCookie("shipstate");
                document.getElementById("shipto_virtuemart_state_id").selectedIndex = shipstate;
                /*var billstate = getCookie("billstate");
                 document.getElementById("virtuemart_state_id").selectedIndex = billstate;
                 update_form();*/
            }
            catch (err) {
    ...
    new Request.JSON({
        ...
        'onSuccess': function (json, text) {
            if (json.error) {
                ...
                /*alert(cart.salesPriceCoupon) ;
                 if (document.getElementById('coupon_price').innerHTML.trim() != "")
                 {

                 document.id('coupon_code_txt').set('text',"Discount applied(" + document.id('coupon_code').value + ")");
                 }
                 else
                 {

                 document.id('coupon_code_txt').set('text',"Wrong coupon code(" + document.id('coupon_code').value + ")");
                 }*/
...
function update_form(task, id) {
    ...
    /********************* custom code */////////
    /*alert (document.getElementById("virtuemart_state_id").length);
     if (document.getElementById("virtuemart_country_id")[document.getElementById("virtuemart_country_id").selectedIndex].value == 223)
     {
     document.getElementById("virtuemart_state_id").style.display = "block";
     document.getElementById("state_field").style.display = "none";
     document.getElementsByClassName('state')[0].style.display = 'none';
     document.getElementsByClassName('virtuemart_state_id')[0].style.display = 'block';
     }
     else
     {
     document.getElementById("virtuemart_state_id").style.display = "none";
     document.getElementById("state_field").style.display = "block";
     document.getElementsByClassName('state')[0].style.display = 'block';
     document.getElementsByClassName('virtuemart_state_id')[0].style.display = 'none';
     }
     if (document.getElementById("shipto_virtuemart_country_id")[document.getElementById("shipto_virtuemart_country_id").selectedIndex].value == 223)
     {
     document.getElementById("shipto_virtuemart_state_id").style.display = "block";
     document.getElementById("shipto_state_field").style.display = "none";
     document.getElementById("reloadState").style.display = "block";
     document.getElementsByClassName('shipto_state')[0].style.display = 'none';
     document.getElementsByClassName('shipto_virtuemart_state_id')[0].style.display = 'block';

     }
     else
     {
     document.getElementById("shipto_virtuemart_state_id").style.display = "none";
     document.getElementById("shipto_state_field").style.display = "block";
     document.getElementById("reloadState").style.display = "none";
     document.getElementsByClassName('shipto_state')[0].style.display = 'block';
     document.getElementsByClassName('shipto_virtuemart_state_id')[0].style.display = 'none';
    ...
    new Request.JSON({
        ...
        'onSuccess': function (json, text) {
            if (json.error) {
                ...
                if (document.getElementById("STsameAsBT").checked == true) {
                    try {
                        var temp = json.price.billTaxAmount;
                        temp = temp.replace("$", "");
                        temp = parseFloat(temp);


                        if (document.getElementById("virtuemart_country_id")[document.getElementById("virtuemart_country_id").selectedIndex].value == 223 && document.getElementById("virtuemart_state_id")[document.getElementById("virtuemart_state_id").selectedIndex].value == 5) {
                            document.id('bill_tax_amount').set('text', json.price.billTaxAmount);
                        }
                        else {
                            document.id('bill_tax_amount').set('text', "$0");
                        }
                ...
                if (document.getElementById("STsameAsBT").checked == true) {
                    if (document.getElementById("virtuemart_country_id")[document.getElementById("virtuemart_country_id").selectedIndex].value == 223
                        && document.getElementById("virtuemart_state_id")[document.getElementById("virtuemart_state_id").selectedIndex].value == 5) {
                        document.id('bill_total').set('text', json.price.billTotal);
                    }
                    else {
                        try {
                            temp = json.price.billTaxAmount;
                            temp = temp.replace("$", "");
                            temp = parseFloat(temp);
                            if (temp > 0) {
                                var ttl = json.price.billTotal;
                                ttl = ttl.replace("$", "");
                                ttl = parseFloat(ttl);
                                ttl = (parseFloat(ttl) - parseFloat(temp));
                                document.id('bill_total').set('text', "$" + ttl.toFixed(2));
                            }
                            else {
                                document.id('bill_total').set('text', json.price.billTotal);
                            }
                ...
                if (document.getElementById("STsameAsBT").checked == false) {
                    if (document.getElementById("shipto_virtuemart_country_id")[document.getElementById("shipto_virtuemart_country_id").selectedIndex].value != 223
                        || document.getElementById("shipto_virtuemart_state_id")[document.getElementById("shipto_virtuemart_state_id").selectedIndex].value != 5) {
                        document.id('bill_tax_amount').set('text', "$0.00");
                        try {
                            temp = json.price.billTaxAmount;
                            temp = temp.replace("$", "");
                            temp = parseFloat(temp);
        ...
        if (document.getElementById('coupon_price').innerHTML == "")
        document.id('coupon_code_txt').set('text', "");
}
).send();
...
?>
    ...
    new Request.JSON({
        ...
        'onSuccess': function (json, text) {
            ...
            if (validationForm("checkoutForm")) {
                if (check_state_case()) {
                    manage_state();
                    manage_state_ship();
                ...
                /* if (document.getElementById("STsameAsBT").checked == true)
                 ...
                 if (confirm("continue with same shipping address as billing address ??"))
                 {

                 }
                 }
                 else if (document.getElementById("STsameAsBT").checked == false)
                 {
                 if (confirm("continue with different shipping and billing address??"))
                 {
                 document.checkoutForm.submit();
                 }
            ...
            /*if (document.getElementById("STsameAsBT").checked == false)
             {
             if (document.getElementById("shipto_zip_field").value == "" || document.getElementById("shipto_address_1_field").value == "" || document.getElementById("shipto_first_name_field").value == "" || document.getElementById("shipto_last_name_field").value == "")
             {
             if (document.getElementById("shipto_first_name_field").value == "")
             {
             document.getElementById("shipto_first_name_field").style.border="1px solid red";
             }
             if (document.getElementById("shipto_last_name_field").value == "")
             {
             document.getElementById("shipto_last_name_field").style.border="1px solid red";
             }
             if (document.getElementById("shipto_address_1_field").value == "")
             {
             document.getElementById("shipto_address_1_field").style.border="1px solid red";
             }
             if (document.getElementById("shipto_zip_field").value == "")
             {
             document.getElementById("shipto_zip_field").style.border="1px solid red";
             }
             }
             else
             {
        ...
        <div class="checkout-button-top">
            ...
            if ($userFieldsModel->getIfRequired('agreed')) {
                ...
                <label for="tosAccepted">
                    ...
                    {
                        $strsp = str_replace("<input ", "<input checked='checked'", VmHtml::checkbox('tosAccepted', $this->cart->tosAccepted, 1, 0, 'class="terms-of-service"'));
                        echo $strsp;
                    }
                    ...
                    if (VmConfig::get('oncheckout_show_legal_info', 1)) {
                        ...
                        <div class="terms-of-service">
                            <span class="terms-of-service" rel="facebox"><span class="vmicon vm2-termsofservice-icon"></span><?php echo 'Accept our Terms of Service, Privacy Policy & Refund Policy'; ?>
                                <span class="vm2-modallink"></span></span>
...
<script type="text/javascript">
    window.onload = function () {
        ...
        update_form();
        manage_state_ship();
        /*document.getElementById("cc_number_2").value = "";
         document.getElementById("cc_cvv_2").value = "";*/

        document.getElementById("shipto_virtuemart_state_id").selectedIndex = 0;


    };
    //document.getElementById("shipto_zip_field").value="";
</script>
