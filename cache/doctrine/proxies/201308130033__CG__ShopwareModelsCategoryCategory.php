...
class Category extends \Shopware\Models\Category\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'parentId', 'name', 'position', 'metaKeywords', 'metaDescription', 'cmsHeadline', 'cmsText', 'active', 'template', 'blog', 'path', 'showFilterGroups', 'external', 'hideFilter', 'hideTop', 'noViewSelect', 'changed', 'added', 'parent', 'children', 'articles', 'allArticles', 'customerGroups', 'attribute', 'emotions', 'media');
    }
