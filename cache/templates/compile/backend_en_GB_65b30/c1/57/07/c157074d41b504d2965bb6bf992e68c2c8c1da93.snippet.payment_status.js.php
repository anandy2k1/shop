<?php /* Smarty version Smarty-3.1.12, created on 2013-10-03 15:04:04
         compiled from "D:\data\Ampps\www\shop\templates\_default\backend\base\model\payment_status.js" */ ?>
<?php /*%%SmartyHeaderCode:5972524d6b444c2564-58780913%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c157074d41b504d2965bb6bf992e68c2c8c1da93' => 
    array (
      0 => 'D:\\data\\Ampps\\www\\shop\\templates\\_default\\backend\\base\\model\\payment_status.js',
      1 => 1376334194,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5972524d6b444c2564-58780913',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_524d6b44a65b42_35103282',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_524d6b44a65b42_35103282')) {function content_524d6b44a65b42_35103282($_smarty_tpl) {?>/**
 * Shopware 4.0
...
Ext.define('Shopware.apps.Base.model.PaymentStatus', {
    ...
    snippets: {
        //
        state9: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'partially_invoiced','default'=>'Partially invoiced','namespace'=>'backend/static/payment_status')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'partially_invoiced','default'=>'Partially invoiced','namespace'=>'backend/static/payment_status'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
        state10: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'completely_invoiced','default'=>'Completely invoiced','namespace'=>'backend/static/payment_status')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'completely_invoiced','default'=>'Completely invoiced','namespace'=>'backend/static/payment_status'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
        state11: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'partially_paid','default'=>'Partially paid','namespace'=>'backend/static/payment_status')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'partially_paid','default'=>'Partially paid','namespace'=>'backend/static/payment_status'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
        state12: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'completely_paid','default'=>'Completely paid','namespace'=>'backend/static/payment_status')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'completely_paid','default'=>'Completely paid','namespace'=>'backend/static/payment_status'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
        state14: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'2nd_reminder','default'=>'2nd reminder','namespace'=>'backend/static/payment_status')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'2nd_reminder','default'=>'2nd reminder','namespace'=>'backend/static/payment_status'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
        state15: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'3rd_reminder','default'=>'3rd reminder','namespace'=>'backend/static/payment_status')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'3rd_reminder','default'=>'3rd reminder','namespace'=>'backend/static/payment_status'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
        state16: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'encashment','default'=>'Encashment','namespace'=>'backend/static/payment_status')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'encashment','default'=>'Encashment','namespace'=>'backend/static/payment_status'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
        state17: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'open','default'=>'Open','namespace'=>'backend/static/payment_status')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'open','default'=>'Open','namespace'=>'backend/static/payment_status'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
        state18: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'reserved','default'=>'Reserved','namespace'=>'backend/static/payment_status')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'reserved','default'=>'Reserved','namespace'=>'backend/static/payment_status'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
        state20: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'re_crediting','default'=>'Re-crediting','namespace'=>'backend/static/payment_status')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'re_crediting','default'=>'Re-crediting','namespace'=>'backend/static/payment_status'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
        state21: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'review_necessary','default'=>'Review necessary','namespace'=>'backend/static/payment_status')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'review_necessary','default'=>'Review necessary','namespace'=>'backend/static/payment_status'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
        state30: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'no_credit_approved','default'=>'No credit approved','namespace'=>'backend/static/payment_status')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'no_credit_approved','default'=>'No credit approved','namespace'=>'backend/static/payment_status'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
        state34: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'a_time_extension_has_been_registered','default'=>'A time extension has been registered','namespace'=>'backend/static/payment_status')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'a_time_extension_has_been_registered','default'=>'A time extension has been registered','namespace'=>'backend/static/payment_status'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
        state35: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'the_process_has_been_cancelled','default'=>'The process has been cancelled.','namespace'=>'backend/static/payment_status')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'the_process_has_been_cancelled','default'=>'The process has been cancelled.','namespace'=>'backend/static/payment_status'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
