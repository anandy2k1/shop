<?php /* Smarty version Smarty-3.1.12, created on 2013-10-03 15:04:16
         compiled from "D:\data\Ampps\www\shop\templates\_default\backend\base\component\Shopware.form.field.ArticleSearch.js" */ ?>
<?php /*%%SmartyHeaderCode:28023524d6b50af8b99-87603065%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '49c42a1020fea7b62b894e72f78a70dd62938e97' => 
    array (
      0 => 'D:\\data\\Ampps\\www\\shop\\templates\\_default\\backend\\base\\component\\Shopware.form.field.ArticleSearch.js',
      1 => 1376334194,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '28023524d6b50af8b99-87603065',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_524d6b512544b7_61984607',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_524d6b512544b7_61984607')) {function content_524d6b512544b7_61984607($_smarty_tpl) {?>/**
 * Shopware 4.0
        ...
        return new Ext.XTemplate(
            '<div class="header">',
                '<div class="header-inner">',
                    '<div class="arrow">&nbsp;</div>',
                    '<span class="title"><?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'search_result'/'article','default'=>'Article','namespace'=>'backend/base/article_search')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'search_result'/'article','default'=>'Article','namespace'=>'backend/base/article_search'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
    ...
    createMultiSelectGridColumns: function() {
        ...
        return [{
            header: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'article_name','default'=>'Article name','namespace'=>'backend/base/article_search')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'article_name','default'=>'Article name','namespace'=>'backend/base/article_search'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
',
            ...
            header: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'ordernumber','default'=>'Order number','namespace'=>'backend/base/article_search')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'ordernumber','default'=>'Order number','namespace'=>'backend/base/article_search'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
