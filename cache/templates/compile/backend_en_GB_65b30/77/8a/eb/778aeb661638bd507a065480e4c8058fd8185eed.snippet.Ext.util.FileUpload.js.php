<?php /* Smarty version Smarty-3.1.12, created on 2013-10-03 15:03:57
         compiled from "D:\data\Ampps\www\shop\engine\Library\ExtJs\components\Ext.util.FileUpload.js" */ ?>
<?php /*%%SmartyHeaderCode:16465524d6b3d5a6ac5-17118577%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '778aeb661638bd507a065480e4c8058fd8185eed' => 
    array (
      0 => 'D:\\data\\Ampps\\www\\shop\\engine\\Library\\ExtJs\\components\\Ext.util.FileUpload.js',
      1 => 1376334192,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16465524d6b3d5a6ac5-17118577',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_524d6b3e121886_31310522',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_524d6b3e121886_31310522')) {function content_524d6b3e121886_31310522($_smarty_tpl) {?>/**
 * Shopware 4.0
...
Ext.define('Ext.util.FileUpload', {
     ...
     *
     * @example requestURL: '<?php echo '/shop/backend/index/test';?>'
     *
     * @string
     */
    requestURL: null,
        ...
        '<div class="inner-dropzone">',
            '<span class="text">',
                '<tpl if="actualQuantity">',
                    "{actualQuantity} " + "{snippet name=file_upload/progress_bar_text default='from' namespace='backend/component/file_upload'}from{/snippet}" + " {totalQuantity}&nbsp;",
                '</tpl>',
                '{text}',
            '</span>',
        '</div>'
...
files uploaded<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'file_upload'/'upload_ready_info','default'=>'files uploaded','namespace'=>'backend/component/file_upload'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
